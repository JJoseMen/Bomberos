...
export class QueryAdminDto {
  ...
  @ApiPropertyOptional({ enum: ['CERTIFICACION_SIPPCI', 'REGISTRO_PROFESIONAL', 'CAPACITACION', 'RENOVACION', 'POLIGONO_TIRO', 'HIDROCARBUROS', 'TURISMO'] })
  @IsOptional()
  @IsEnum(['CERTIFICACION_SIPPCI', 'REGISTRO_PROFESIONAL', 'CAPACITACION', 'RENOVACION', 'POLIGONO_TIRO', 'HIDROCARBUROS', 'TURISMO'] as const)
  tipoTramite?: string;
